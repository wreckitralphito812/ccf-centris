...
export const volunteerRoles: VolunteerRole[] = [
  ...
  { id: "vr-6", slug: "production", title: "Production", description: "Sound, lighting, slides, and stream. The team that makes everything else work.", commitment: "Two Sundays a month", requirements: "Willing to learn. Technical background helps but is not required.", schedule_note: "Sundays", training_note: "Paired with a lead operator for four services.", is_open: true, ministry: "Production" },
  ...
  { id: "vr-12", slug: "elevate-leader", title: "Elevate Small Group Leader", description: "Lead a Dgroup of students through the school year. The single highest-impact role we have.", commitment: "Friday nights plus your group", requirements: "Background check. Committed to a full school year.", schedule_note: "Fridays", training_note: "GLC 3 recommended, plus Elevate leader training.", is_open: true, ministry: "Elevate" },
];
